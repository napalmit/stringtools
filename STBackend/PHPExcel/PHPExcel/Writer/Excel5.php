...
require(PHPEXCEL_ROOT . 'PHPExcel/Writer/Excel5/BIFFwriter.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Writer/Excel5/Escher.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Writer/Excel5/Font.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Writer/Excel5/Parser.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Writer/Excel5/Workbook.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Writer/Excel5/Worksheet.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Writer/Excel5/Xf.php');
