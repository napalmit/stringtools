...
require(PHPEXCEL_ROOT . 'PHPExcel/Calculation/Function.php');
require(PHPEXCEL_ROOT . 'PHPExcel/CalcEngine/CyclicReferenceStack.php');
require(PHPEXCEL_ROOT . 'PHPExcel/CalcEngine/Logger.php');
require(PHPEXCEL_ROOT . 'PHPExcel/IComparable.php');
