...
require(PHPEXCEL_ROOT . 'PHPExcel/Style/Supervisor.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Style/Font.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Style/Color.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Style/Fill.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Style/Borders.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Style/Border.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Style/Alignment.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Style/NumberFormat.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Style/Protection.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Style/Conditional.php');
/**
 * PHPExcel_Style
 *
 * @category   PHPExcel
