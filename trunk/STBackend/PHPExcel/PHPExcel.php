...
require(PHPEXCEL_ROOT . 'PHPExcel/Calculation.php');
require(PHPEXCEL_ROOT . 'PHPExcel/DocumentProperties.php');
require(PHPEXCEL_ROOT . 'PHPExcel/DocumentSecurity.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Style.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Cell.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Cell/DataType.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Cell/DefaultValueBinder.php');
require(PHPEXCEL_ROOT . 'PHPExcel/ReferenceHelper.php');
require(PHPEXCEL_ROOT . 'PHPExcel/WorksheetIterator.php');
require(PHPEXCEL_ROOT . 'PHPExcel/IOFactory.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Writer/Excel5.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Worksheet.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Worksheet/PageSetup.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Worksheet/PageMargins.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Worksheet/HeaderFooter.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Worksheet/SheetView.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Worksheet/Protection.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Worksheet/RowDimension.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Worksheet/ColumnDimension.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Worksheet/AutoFilter.php');
require(PHPEXCEL_ROOT . 'PHPExcel/CachedObjectStorageFactory.php');
require(PHPEXCEL_ROOT . 'PHPExcel/CachedObjectStorage/Memory.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Calculation/Functions.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Shared/OLE.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Shared/Font.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Shared/Date.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Shared/File.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Shared/OLE/PPS.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Shared/OLE/PPS/File.php');
require(PHPEXCEL_ROOT . 'PHPExcel/Shared/OLE/PPS/Root.php');
/**
 * PHPExcel
 *
 * @category   PHPExcel
